...
function drawtagcloud(jsonfilename,i){
    ...
    wordsarr=wordsarr.sort(compare).slice(0,20);
    // console.log();
 ...
 //    d3.select("#vis3text").text("Word Cloud for Book:  > Chapter: ");
	...
	// 	.append("div").attr("id","chartvis3")
       var tooltiplayout= divtooltip.html("")
        .append("svg")
        .attr("width", 300)
        .attr("height", 240);
	 ...
	 d3.layout.cloud()
        ...
        .rotate(0)
        .font("sans-serif")
        .fontSize(function(d) { return d.size; })//return xScale(+d.size); })
